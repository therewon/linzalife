    ...
    return (
        <div>
            ...
            <main className="home flex flex-col items-center">
                <div data-aos="fade-up" className="flex flex-col my-[50px] w-[80%] lg:flex-row">
                    <aside >
                    ...
                    <img className="w-[600px] h-[400px]" src="https://cdn.shopify.com/s/files/1/0447/5115/9447/files/grid-banner-1_e9969506-5a7c-48d3-9253-1c14b7716ab0_600x.jpg?v=1615322226"></img>
                </div>
                <div data-aos="fade-up" className="flex flex-col my-[50px] w-[80%] lg:flex-row flex-col-reverse">
                    <img className="w-[571px] h-[571px]" src="https://contactsforless.ca/wp-content/uploads/2018/07/bausch-and-lomb-sight-savers-contact-lens-case.jpg" />
                    <aside>
                ...
                <div className="flex w-full p-[50px] bg-[#F5F2F5] justify-center" data-aos="fade-up">
                    <div className="flex flex-col w-[80%] gap-8 lg:flex-row">
                ...
                <div data-aos="fade-up" className="flex flex-col lg:flex-row items-center w-[80%] my-10 ">
                    <aside >
                ...
                <div  data-aos="fade-up" className="flex flex-col my-[50px]  items-center justify-center">
                ...
                <div data-aos="fade-up" className="flex flex-col my-[50px] w-[80%] md:flex-row p-5 gap-4">
